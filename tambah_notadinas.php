<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['no_agenda'] == "" || $_REQUEST['no_surat'] == "" || $_REQUEST['pelaksana'] == "" || $_REQUEST['perihal'] == ""
                || $_REQUEST['tempat_kegiatan'] == "" || $_REQUEST['tgl_surat'] == ""  || $_REQUEST['keterangan'] == ""){
                ...
                $tempat_kegiatan = $_REQUEST['tempat_kegiatan'];
                ...
                if(!preg_match("/^[0-9]*$/", $no_agenda)){
                    ...
                    if(!preg_match("/^[a-zA-Z0-9.\/ -]*$/", $no_surat)){
                        ...
                        if(!preg_match("/^[a-zA-Z0-9.,() \/ -]*$/", $pelaksana)){
                            $_SESSION['pelaksana'] = 'Form Pelaksana hanya boleh mengandung karakter huruf, angka, spasi, titik(.), koma(,), minus(-), kurung() dan garis miring(/)';
                            echo '<script language="javascript">window.history.back();</script>';
                        } else {
                            ...
                            if(!preg_match("/^[a-zA-Z0-9.,_()%&@\/\r\n -]*$/", $perihal)){
                                ...
                                if(!preg_match("/^[a-zA-Z0-9.,() \/ -]*$/", $tempat_kegiatan)){
                                    $_SESSION['tempat_kegiatan'] = 'Form Pelaksana hanya boleh mengandung karakter huruf, angka, spasi, titik(.), koma(,), minus(-), kurung() dan garis miring(/)';
                                    echo '<script language="javascript">window.history.back();</script>';
                                } else {
                                                ...
                                                if($file != ""){
                                                    ...
                                                    if(in_array($eks, $ekstensi) == true){
                                                        if($ukuran < 2500000){
                                                            ...
                                                            $query = mysqli_query($config, "INSERT INTO tbl_surat_keluar(no_agenda,no_surat,perihal,pelaksana,tempat_kegiatan, tgl_surat,
                                                                tgl_catat,file,keterangan,id_user)
                                                                VALUES('$no_agenda','$no_surat','$perihal','$pelaksana','$tempat_kegiatan','$tgl_surat',NOW(),'$nfile','$keterangan','$id_user')");
                                                    ...
                                                    $query = mysqli_query($config, "INSERT INTO tbl_surat_keluar(no_agenda,no_surat,perihal,pelaksana,tempat_kegiatan, tgl_surat,
                                                        tgl_catat,file,keterangan,id_user)
                                                        VALUES('$no_agenda','$no_surat','$perihal','$pelaksana','$tempat_kegiatan','$tgl_surat',NOW(),' ','$keterangan','$id_user')");
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=tnd&act=add" class="judul"><i class="material-icons">drafts</i> Tambah Data Nota Dinas</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <!-- Form START -->
                <form class="col s12" method="POST" action="?page=tnd&act=add" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="tempat_kegiatan" type="text" class="validate" name="tempat_kegiatan" required>
                                <?php
                                    if(isset($_SESSION['tempat_kegiatan'])){
                                        $tempat_kegiatan = $_SESSION['tempat_kegiatan'];
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$tempat_kegiatan.'</div>';
                                        unset($_SESSION['tempat_kegiatan']);
                                    }
                                ?>
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="tgl_surat" type="text" name="tgl_surat" class="datepicker" required>
                                ...
                                ?>
                            <label for="tgl_surat">Tanggal Kegiatan</label>
                        </div>
                        <div class="input-field col s6">
                    ...
                    <div class="row">
                        ...
                        <div class="col 6">
                            <a href="?page=tnd" class="btn-large deep-orange waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>
                        </div>
                    </div>
