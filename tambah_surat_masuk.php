                                                ...
                                                if($file != ""){
                                                    ...
                                                    if(in_array($eks, $ekstensi) == true){
                                                        if($ukuran < 2500000){
                                                            ...
                                                            $query = mysqli_query($config, "INSERT INTO tbl_surat_masuk(no_agenda,no_surat,asal_surat,perihal,indeks,tgl_surat,
                                                                    tgl_diterima,file,disposisi,id_user)
                                                                        VALUES('$no_agenda','$no_surat','$asal_surat','$perihal','$indeks','$tgl_surat',NOW(),'$nfile','$disposisi','$id_user')");
                                                    ...
                                                    $query = mysqli_query($config, "INSERT INTO tbl_surat_masuk(no_agenda,no_surat,asal_surat,perihal,indeks,tgl_surat, tgl_diterima,file,disposisi,id_user)
                                                            VALUES('$no_agenda','$no_surat','$asal_surat','$perihal','$indeks','$tgl_surat',NOW(),'','$disposisi','$id_user')");
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                         ...
                         <div class="input-field col s6">
                            ...
                            <input id="disposisi" type="text" class="validate" name="disposisi" required>
                                <?php
